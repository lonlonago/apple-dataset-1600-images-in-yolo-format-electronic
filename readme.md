# Apple dataset 1600 images in YOLO format electronic

# Body

Apple dataset, 1600 images in YOLO format， rich in image content, suitable for apple-related target detection, image segmentation, algorithm performance improvement and other projects, ready to use, worry-free.

send the download link to the cloud storage
